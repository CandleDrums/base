...
public class Range<T> implements Serializable {
     ...
     * </p>
     * <p>
     * Natural ordering uses an internal comparator implementation, thus this method is the only way to check if a null
     ...
     * </p>
     * <p>
     * The API is reminiscent of the Comparable interface returning {@code -1} if the element is before the range,
     * {@code 0} if contained within the range and {@code 1} if the element is after the range.
     * </p>
     *
     ...
     * </p>
     * <p>
     * This uses {@link java.util.Formattable} to perform the formatting. Three variables may be used to embed the
     * minimum, maximum and comparator. Use {@code %1$s} for the minimum element, {@code %2$s} for the maximum element
     * and {@code %3$s} for the comparator. The default format used by {@code toString()} is {@code [%1$s..%2$s]}.
     * </p>
     * 

...
public class BooleanUtils {
     ...
     * used as {@code BooleanUtils.negate(true);}.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Checks if a {@code Boolean} value is <i>not</i> {@code false}, handling {@code null} by returning {@code true}.
     * </p>
     *
     * <pre>
     ...
     * @return the Boolean value of the string, {@code null} if either the String matches {@code nullString} or if
     * {@code null} input and {@code nullString} is {@code null}
     ...
     * </p>
     * <p>
     * This method performs 4 times faster (JDK1.4) than {@code Boolean.valueOf(String)}. However, this method accepts

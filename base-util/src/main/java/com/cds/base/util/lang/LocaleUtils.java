 ...
 * @Class LocaleUtils.java
 * @Date 2016年8月18日 上午11:07:35
...
public class LocaleUtils {
    ...
    /**
     * <p>
     * {@code LocaleUtils} instances should NOT be constructed in standard programming. Instead, the class should be
     * used as {@code LocaleUtils.toLocale("en_GB");}.
     * </p>
     * <p>
     ...
     * </pre>
     * <p>
     * (#) The behaviour of the JDK variant constructor changed between JDK1.3 and JDK1.4. In JDK1.3, the constructor
    ...
    public static Locale toLocale(final String str) {
        ...
        switch (occurrences) {
            ...
            case 2:
                if (StringUtils.isAllLowerCase(split[0]) && (split[0].length() == 2 || split[0].length() == 3)
                    && (split[1].length() == 0 || (split[1].length() == 2 && StringUtils.isAllUpperCase(split[1]))) && split[2].length() > 0) {
     ...
     * </pre>
     * <p>
     * The result list begins with the most specific locale, then the next more general and so on, finishing with the
     * default locale. The list will never contain the same locale twice.
     * </p>
     *
     ...
     * </p>
     * <p>
     * This method is a wrapper around {@link Locale#getAvailableLocales()}. It is more efficient, as the JDK method
     * must create a new array each time it is called.
     * </p>
     *
     ...
     * </p>
     * <p>
     * This method takes a country code and searches to find the languages available for that country. Variant locales
     * are removed.
     * </p>
     *
     ...
     * </p>
     * <p>
     * This method takes a language code and searches to find the countries available for that language. Variant locales
     * are removed.
     * </p>
     *

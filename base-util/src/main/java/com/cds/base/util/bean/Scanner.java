 ...
 * @Class Scanner.java
 * @Date 2019年7月27日 下午4:38:05
 * @Copyright (c) 2019 candledrums All Right Reserved.
 */
package com.cds.base.util.bean;
...
public class Scanner {
    ...
    public Set<Class<?>> getInterfaceByAnnotation(String packageName, Class annotationClass) throws Exception {
        Set<Class<?>> classes = new HashSet<>();

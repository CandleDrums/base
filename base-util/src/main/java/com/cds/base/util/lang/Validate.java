...
public class Validate {
     ...
     * null element at index: &quot; followed by the index.
     * </p>
     *
     * @param <T> the array type
     * @param array the array to check, validated not null by this method
     ...
     * contains null element at index: &quot; followed by the index.
     * </p>
     *
     * @param <T> the iterable type
     * @param iterable the iterable to check, validated not null by this method
    ...
    /**
     * Validate that the specified primitive value falls between the two inclusive values specified; otherwise, throws
     * an exception.
     *
     * <pre>
     * Validate.inclusiveBetween(0, 2, 1);
    ...
    /**
     * Validate that the specified primitive value falls between the two exclusive values specified; otherwise, throws
     * an exception.
     *
     * <pre>
     * Validate.exclusiveBetween(0, 2, 1);

 ...
 * @Class EnumUtils.java
 * @Date 2016年8月18日 上午10:33:16
...
public class EnumUtils {
     ...
     * </p>
     * <p>
     * Do not use this method if you have more than 64 values in your Enum, as this would create a value greater than a
     * long can hold.
     * </p>
     *
     ...
     * @throws IllegalArgumentException if {@code enumClass} is not an enum class or has more than 64 values, or if any
     ...
     * @param values the values we want to convert, not {@code null}, neither containing {@code null}
     * @param <E> the type of the enumeration
     * @return a long[] whose values provide a binary representation of the given set of enum values with least
     * significant digits rightmost.
     * @throws NullPointerException if {@code enumClass} or {@code values} is {@code null}
    ...
    /**
     * <p>
     * Convert a long value created by {@link EnumUtils#generateBitVector} into the set of enum values that it
     * represents.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Convert a {@code long[]} created by {@link EnumUtils#generateBitVectors} into the set of enum values that it
     * represents.
     * </p>
     * <p>
     * If you store this value, beware any changes to the enum that would affect ordinal values.
     ...
     * 
     * @param enumClass the class of the enum we are working with, not {@code null}
     * @param values the long[] bearing the representation of a set of enum values, least significant digits rightmost,
     * not {@code null}
     * @param <E> the type of the enumeration
     * @return a set of enum values
     * @throws NullPointerException if {@code enumClass} is {@code null}

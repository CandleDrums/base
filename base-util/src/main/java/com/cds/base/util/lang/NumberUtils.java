 ...
 * @Class NumberUtils.java
 * @Date 2016年8月18日 上午10:50:27
...
public class NumberUtils {
     ...
     * </p>
     * <p>
     * Then, the value is examined for a type qualifier on the end, i.e. one of <code>'f','F','d','D','l','L'</code>. If
    ...
    public static Number createNumber(final String str) throws NumberFormatException {
        ...
        if (decPos > -1) { // there is a decimal point
            ...
            numDecimals = dec.length(); // gets number of digits past the decimal to ensure no loss of precision for
        ...
        try {
            if (numDecimals <= 16) {// If number has between 8 and 16 digits past the decimal point then make it a
                                    // double
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>Integer</code>, handling hex (0xhhhh) and octal (0dddd) notations. N.B.
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>Long</code>; since 3.1 it handles hex (0Xhhhh) and octal (0ddd)
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>BigInteger</code>; since 3.2 it handles hex (0x or #) and octal (0)
     * notations.
     * </p>
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.
    ...
    public static BigInteger createBigInteger(final String str) {
        ...
        if (str.startsWith("0x", pos) || str.startsWith("0X", pos)) { // hex
            ...
            radix = 16;
            pos++;
        } else if (str.startsWith("0", pos) && str.length() > pos + 1) { // octal; so long as there are additional
                                                                         // digits
            radix = 8;
            pos++;
     ...
     * </p>
     * <p>
     * Valid numbers include hexadecimal marked with the <code>0x</code> or <code>0X</code> qualifier, octal numbers,
     ...
     * <code>09</code> will return <code>false</code>, since <code>9</code> is not a valid octal value. However, numbers
     * beginning with {@code 0.} are treated as decimal.
     * </p>
     * <p>
     * <code>null</code> and empty/blank {@code String} will return <code>false</code>.
     * </p>
     *
     * @param str the <code>String</code> to check
     ...
     * </p>
     * <p>
     * Hexadecimal and scientific notations are <strong>not</strong> considered parsable. See {@link #isNumber(String)}
     * on those cases.
     * </p>
     * <p>
     * {@code Null} and empty String will return <code>false</code>.
     * </p>
     *
     * @param str the String to check.

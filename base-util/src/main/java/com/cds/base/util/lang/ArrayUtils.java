...
public class ArrayUtils {
     ...
     *
     * @param array
     *            an array whose elements are either a {@link java.util.Map.Entry} or an Array containing at least two
     ...
     *
     * @param array
     *            the array to travers backwords looking for the object, may be {@code null}
     * @param objectToFind
     *            the object to find, may be {@code null}
     ...
     * @throws IndexOutOfBoundsException
     *             if any index is out of range (index &lt; 0 || index &gt;= array.length), or if the array is
     *             {@code null}.
     * @since 3.0.1
     */
     ...
     * @return A new array containing the existing elements except the earliest-encountered occurrences of the specified
     *         elements.
     * @since 3.0.1
     */
    @SafeVarargs
    ...
    /**
     * <p>
     * This method checks whether the provided array is sorted according to natural ordering ({@code false} before
     * {@code true}).
     * </p>
     *
     * @param array

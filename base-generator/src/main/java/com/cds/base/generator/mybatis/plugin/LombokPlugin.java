 ...
 * @Class LombokPlugin.java
 * @Date Sep 9, 2020 5:51:19 PM
...
public class LombokPlugin extends PluginAdapter {
     ...
     *
     * @param method
     *            the getter, or accessor, method generated for the specified column
     * @param topLevelClass
     *            the partially implemented model class
     * @param introspectedColumn
     *            The class containing information about the column related to this field as introspected from the
     *            database
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
     ...
     *
     * @param method
     *            the setter, or mutator, method generated for the specified column
     * @param topLevelClass
     *            the partially implemented model class
     * @param introspectedColumn
     *            The class containing information about the column related to this field as introspected from the
